...
(() => {
    ...
    for (const timezone in timezoneOptions) {
        const optionElement = (() => {
            const data = timezoneOptions[timezone];
        ...
        timezoneDropdown.appendChild(optionElement);
    }
})();
...
//         if (timezoneSearch == undefined) {
//             return;
//         }

//         /** @type {string} */
//         const userInput = timezoneSearch.value.toLowerCase();
//         const selectOptions = document.getElementById("timezone");

//         for (var i = 0; i < selectOptions.children.length; ++i) {
//             const option = selectOptions.children[i];

//             if (!option.innerHTML.toLowerCase().includes(userInput.toLowerCase())) {
